...
<html>
    ...
    <div class="container">
        ...
        <?php
            ...
            $sql = "SELECT * FROM subject_table WHERE '{$_SESSION['username']}' = teacher_name";
                ...
                if(mysqli_num_rows($result) > 0){
                    ...
                    while($row = mysqli_fetch_array($result)){
                        echo "<tr>";
                            ...
                            echo "<td>" . $row['subject_name'] . " <a href='viewattendance.php' style='color: inherit;'><button class='btn btn-default' style='margin-left: 12px; margin-right: 5px;'>View</button></a> <a href='takeattendance.php' style='color: inherit;'><button class='btn btn-default'>Take Attendance</button></a></td>";
                        echo "</tr>";
                    }
                    echo "</table>";
                    // Free result set
