            ...
            if($result = mysqli_query($link, $sql)){
                if(mysqli_num_rows($result) > 0){
                    echo "<table class='table table-bordered table-responsive' style='margin: 0 auto; margin-top: 130px; width: 850px;'>";
                        echo "<tr>";
                            echo "<th>ID</th>";
                            echo "<th>Student AUN ID</th>";
                            echo "<th>Student Fullname</th>";
                    ...
                    while($row = mysqli_fetch_array($result)){
                        echo "<tr>";
                            ...
                            echo '<td><button class="btn btn-default" type="button"><a href="student_update.php?std_roll_no=' . $row['std_roll_no'] . '">Update</a></button> <button class="btn btn-danger" type="button"><a href="student_delete.php?std_roll_no=' . $row['std_roll_no'] . '" style="color: inherit;">Delete</a></button></td>';
                        echo "</tr>";
                    }
                    echo "</table>";
                    // Free result set
