...
<?php
    ...
    if(isset($_POST['submit'])){
      ...
      $sql2 = "INSERT INTO student_table (aunid, fullname, email) VALUES ('$aunid','$fullname','$email')";
        ...
        <table class="table table-bordered table-responsive" style="margin: 0 auto; margin-top: 130px; width: 500px;">
            <tbody>
                ...
                <tr>
                    ...
                    <td><input class="form-control" placeholder="Student AUN ID" type="text" name="aunid" required></td>
                </tr>
                <tr>
                    <td>Student Fullname</td>
                    <td><input class="form-control" placeholder="Student Fullname" type="text" name="fullname" required></td>
                </tr>
                <tr>
                    <td>Student E-mail</td>
                    <td><input class="form-control" placeholder="Student E-mail Address" type="email" name="email" required></td>
                </tr>
                <tr align="center">
